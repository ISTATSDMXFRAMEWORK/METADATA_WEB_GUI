...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <iup:IstatUpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <br />
            <br />
            <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" OnClientClick="location.href='./ContentConstraintItemDetails.aspx?ACTION=INSERT';return false;" Text="<%$ Resources:Messages, btn_new_contentconstraint %>" />
        </ContentTemplate>
