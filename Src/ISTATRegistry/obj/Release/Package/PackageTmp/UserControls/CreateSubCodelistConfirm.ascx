<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CreateSubCodelistConfirm.ascx.cs" Inherits="ISTATRegistry.UserControls.CreateSubCodelistConfirm" %>
<%@ Reference VirtualPath="~/UserControls/CreateSubCodelistForm.ascx" %>
<input id="btnOpenPopUp" type="button" value="<%=Resources.Messages.btn_Create_SubCodelist %>" onclick='javascript: openP("dialog-form<%=this.ClientID %>")' />

<div id="dialog-form<%=this.ClientID %>" class="popup_block" >
    
    <asp:Label ID="lblTitle" runat="server" 
        Text="<%$ Resources:Messages, btn_Create_SubCodelist %>" CssClass="PageTitle"></asp:Label>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td>
                <asp:Button ID="btnSave" runat="server" Text="<%$ Resources:Messages, btn_save %>" OnClientClick = "return ConfirmBeforeCreate()"
                    ToolTip="<%$ Resources:Messages, btn_save %>" onclick="btnSave_Click"/>
            </td>
        </tr>
    </table>
    <script>
