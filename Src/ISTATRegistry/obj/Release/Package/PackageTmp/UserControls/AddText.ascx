...
<asp:Panel ID="pnlEditText" runat="server">
    <asp:GridView ID="gvText" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <asp:ImageButton ID="ibUpdate" runat="server" CausesValidation="False" CommandName="Edit"
                        Text="<%# Resources.Messages.lbl_update %>" ImageUrl="../images/Edit_mini.png"
                        ToolTip="<%# Resources.Messages.lbl_update %>" />
                </ItemTemplate>
                <HeaderStyle Width="5px" />
            </asp:TemplateField>
        </Columns>
...
<%--    <a href='javascript: openP("dialog-form<%=_sessionName %>",900)' title="<%= Resources.Messages.lbl_add_text %>">
    ...
    <asp:ImageButton ID="btnAddOpenPopUp" runat="server" ImageUrl="../images/Add.png" 
                ToolTip="<%# Resources.Messages.lbl_add_text %>" 
                Text="<%# Resources.Messages.lbl_add_text %>"
                OnClick="btnAddOpenPopUp_Click"/>
...
<div id="dialog-form<%=_sessionName %>" class="popup_block">
    ...
    <table style="width: 100%">
        ...
        <tr>
            <td>
                <asp:Button ID="btnAdd" runat="server" Font-Size="Small" Text="<%# Resources.Messages.btn_save %>"
