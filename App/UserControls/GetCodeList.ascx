...
<a href='javascript: openP("df_CodeList<%=ControlID %>",<%=PopUpWidth %>)' title="<%= Resources.Messages.lbl_codelist %>">
    <img src="./images/<%=IconFileName %>" border="0" alt="<%= Resources.Messages.lbl_codelist %>" /></a><asp:ImageButton OnClick="btnDeleteText_Click" ID="btnDeleteText" runat="server" Visible="false" ImageUrl="~/images/Delete_mini.png" />
