                ...
                <iup:IstatUpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvDimension" runat="server" Width="100%" AllowPaging="True" CssClass="Grid"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="N." SortExpression="num">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="" ShowHeader="False">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ibDimEdit" runat="server" CausesValidation="False" CommandName="Details"
                                            CommandArgument="<%# Container.DataItemIndex %>" ImageUrl="~/images/Details2.png"
                        ...
                        <asp:Panel ID="pnlAddDimension" runat="server">
                            <asp:ImageButton ID="btnOpenAddDimensionPopUp" ImageUrl="./images/Add.png"
                                    AlternateText="<%# Resources.Messages.lbl_add_dimension%>"
                                    runat="server" OnClick="btnOpenAddDimensionPopUp_Click"/>
<%--                            <a href='javascript: openP("df-Dimension",600)' title="<%# Resources.Messages.lbl_add_dimension%>">
                        ...
                        <div id="df-Dimension" class="popup_block">
                            ...
                            <table class="tableForm">
                                ...
                                <tr>
                                    <td width="35%">
                                        <asp:Label ID="lblOrder" runat="server" Text="<%$ Resources: Messages, lbl_order %>"
                                            CssClass="tdProperty"></asp:Label>
                                    </td>
                                    <td width="65%">
                                        <asp:TextBox ID="txtDimOrder" runat="server" Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:HiddenField ID="hdnEditDimension" runat="server" />
                                        <asp:Button ID="btnAddDimension" runat="server" Text="<%# Resources.Messages.btn_save%>"
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvGroups" runat="server" Width="100%" AllowPaging="True" CssClass="Grid"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="" ShowHeader="False">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ibGroupEdit" runat="server" CausesValidation="False" CommandName="Details"
                                            CommandArgument="<%# Container.DataItemIndex %>" ImageUrl="~/images/Details2.png"
                                            ToolTip="View/Edit Details" />
                                    </ItemTemplate>
                                    <HeaderStyle Width="50px" HorizontalAlign="Center" />
                        ...
                        <asp:Panel ID="pnlAddGroup" runat="server">
                            <asp:ImageButton ID="btnOpenAddGroupPopUp" ImageUrl="./images/Add.png"
                                    AlternateText="<%# Resources.Messages.lbl_add_group%>"
                                    runat="server" OnClick="btnOpenAddGroupPopUp_Click"/>
                        ...
                        <div id="df-Group" class="popup_block">
                            ...
                            <table style="width: 470px">
                                ...
                                <tr>
                                    <td>
                                        <br />
                                        <asp:Button ID="btnAddGroup" runat="server" Text="<%# Resources.Messages.btn_save%>"
                                            OnClick="btnAddGroup_Click" />
                                        <asp:HiddenField ID="hdnEditGroup" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <ContentTemplate>
                        ...
                        <div id="df-Attribute" class="popup_block" title="Add Attribute">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td width="35%">
                                        <asp:Label ID="lblAttOrder" runat="server" Text="<%$ Resources: Messages, lbl_order %>"
                                            CssClass="tdProperty"></asp:Label>
                                    </td>
                                    <td width="65%">
                                        <asp:TextBox ID="txtAttOrder" runat="server" Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            ...
                            <br />
                            <asp:Button ID="btnAddAttribute" runat="server" Text="<%$ Resources: Messages, btn_save %>" OnClick="btnAddAttribute_Click" />
