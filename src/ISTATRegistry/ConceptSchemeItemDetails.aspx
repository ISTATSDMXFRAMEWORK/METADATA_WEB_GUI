...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divBack">
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/conceptschemes.aspx?m=y" ImageUrl="~/images/back.png"><%= Resources.Messages.lbl_back %></asp:HyperLink>
    </div>
...
<%--                <iup:IstatUpdatePanel ID="IstatUpdatePanel2" runat="server">
                    <ContentTemplate>--%>
                        ...
                        <asp:GridView ID="gvConceptschemesItem" runat="server" Width="730px"
                            AllowPaging="True"
                            CssClass="Grid"
                            OnPageIndexChanging="gvConceptschemesItem_PageIndexChanging" OnRowDeleting="gvConceptschemesItem_RowDeleting"
                            OnRowCommand="gvConceptschemesItem_RowCommand" OnRowUpdating="gvConceptschemesItem_RowUpdating"
                            AutoGenerateColumns="False" OnRowDataBound="gvConceptschemesItem_RowDataBound">
                            <Columns>
                        ...
                        <div style="float: left">
                            <asp:Button ID="btnAddNewConcept" Visible="false" Text="<%$ Resources:Messages,lbl_add_concept %>" OnClientClick="javascript: openP('df-Dimension',600); return false;" runat="server" OnClick="btnAddNewConcept_Click" />
                        </div>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <center>
                                            ...
                                            <br />
                                            <asp:Button OnClick="btnAddConceptToFinalStructure_Click" Visible="false" ID="btnAddConceptToFinalStructure" runat="server" Text="<%$  Resources: Messages, btn_add_concept %>" />
