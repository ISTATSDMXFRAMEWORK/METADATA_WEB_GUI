...
namespace ISTATRegistry.UserControls
{
    public partial class AddText : System.Web.UI.UserControl
    {
        ...
        protected void gvText_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            cmbLanguage.SelectedValue = ((Label)gvText.Rows[e.NewEditIndex].FindControl("lblLanguage")).Text;
            hdnAction.Value = Action.UPDATE.ToString();
        ...
        protected void btnAddOpenPopUp_Click(object sender, ImageClickEventArgs e)
        {
            ExecuteJSPostback();
            OpenDialogForm();
            cmbLanguage.SelectedValue = Session[SESSION_KEYS.KEY_LANG].ToString();
            txtText.Text = "";
            hdnAction.Value = Action.INSERT.ToString();
        }
